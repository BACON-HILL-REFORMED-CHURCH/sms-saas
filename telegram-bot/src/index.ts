...
const REFERRAL_BONUS     = parseInt(process.env.REFERRAL_BONUS ?? '00');
...
const DIGITAL_CATEGORIES = [
  ...
  { id: 'vpn',         emoji: '⚡', label: 'VPN |1$|' },
  { id: 'office',      emoji: '⚡', label: 'Office 365' },
  { id: 'gemini',      emoji: '⚡', label: 'Gemini PRO |1.99$|' },
  { id: 'higgsfield',  emoji: '⚡', label: 'Higgsfield' },
  { id: 'adobe',       emoji: '⚡', label: 'ADOBE FULL APP |2.2$|' },
  { id: 'LinkedinCareer',       emoji: '⚡', label: 'Linkedin Career |2.5$|' },
  { id: 'N8NStarter12MOI',       emoji: '⚡', label: 'N8N Starter 12MOI |16.99$|' },
  { id: 'CourseraPremium12m',       emoji: '⚡', label: 'Coursera Premium 12m |2.99$|' },
  { id: 'QUILLBOTPREMIUM',       emoji: '⚡', label: 'QUILLBOT PREMIUM |2.89$|' },
  { id: 'SuperDuolingo',       emoji: '⚡', label: 'Super Duolingo |1.99$|' },
  { id: 'Prime6Moi',       emoji: '⚡', label: 'Prime 6Moi |3.50$|' },
  { id: 'PicsartPro11Months ',   emoji: '⚡', label: 'Picsart Pro 11 Months  |6.90$|' },
  { id: 'GrokSuper7D',   emoji: '⚡', label: 'Grok Super 7D |1.70$|' },
  { id: 'GrokSuper13-14D',   emoji: '⚡', label: 'Grok Super 13-14D|3.50$|' },
  { id: 'GrokSuper30Days',   emoji: '⚡', label: 'Grok Super 30 Days|5.99$|' },
  { id: 'SuperGrok3Months',   emoji: '⚡', label: 'Super Grok 3 Months|15.99$|' },
  ...
  { id: 'StudocuPremium1Month',      emoji: '⚡', label: 'Studocu Premium 1 Month |2.90$|' },
  { id: 'PixVersePro',      emoji: '⚡', label: 'PixVerse Pro |29.90$|' },
  { id: 'XPremium3Months',      emoji: '⚡', label: 'X Premium 3 Months |13.90$|' },
  { id: 'OpenArtAdvanced',      emoji: '⚡', label: 'OpenArt Advanced |12.90$|' },
  { id: 'Kling',      emoji: '⚡', label: 'Kling |1.99$|' },
  ...
  { id: 'DESCORDNITRO',   emoji: '⚡', label: 'DESCORD NITRO|3$|' },
  { id: 'LOVABLEPROAI',   emoji: '⚡', label: 'LOVABLE PRO AI|3.50$|' },
  { id: 'Kling66Cre',   emoji: '⚡', label: 'Kling 66 Cre|0.80$|' },
  { id: 'NotionPlusEdu',   emoji: '⚡', label: 'Notion Plus Edu |9.99$|' },
  { id: 'FigmaProEducation',   emoji: '⚡', label: 'Figma Pro Education |9.99$|' },
  { id: 'CursorPro',   emoji: '⚡', label: 'Cursor Pro |16.99$|' },
  { id: 'ZoomPro',   emoji: '⚡', label: 'Zoom Pro  |2.50$|' },
  { id: 'CursorPro',   emoji: '⚡', label: 'Cursor Pro   |16$|' },
  { id: 'NotionBusiness3months',   emoji: '⚡', label: 'Notion Business 3 months|16$|' },
  { id: 'NotionBusiness3months',   emoji: '⚡', label: 'Notion Business 3 months|16$|' },
  { id: 'GithubStudent',   emoji: '⚡', label: 'Github Student|5$|' },
  { id: 'Canvaedu',       emoji: '⚡', label: 'Canva edu |0.9$|' },
  { id: '𝗔𝗪𝗦𝟱𝘃𝗖𝗣𝗨',   emoji: '⚡', label: '𝗔𝗪𝗦 𝟱 𝘃𝗖𝗣𝗨 𝐔𝐊 | 6.5$ |' },
  { id: 'Azure𝐅𝐫𝐞𝐞𝐓𝐫𝐢𝐚𝐥', emoji: '⚡', label: ' Azure 𝐅𝐫𝐞𝐞 𝐓𝐫𝐢𝐚𝐥 $200 |$6| ' },
  { id: 'APICLAUDE10MTOKEN1D',   emoji: '⚡', label: 'API CLAUDE 10M TOKEN |1.99$|' },
  { id: 'APICODEX10MTOKEN1D',   emoji: '⚡', label: 'API CODEX 10M TOKEN |1.99$|' },
